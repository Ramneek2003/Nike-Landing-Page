...
const Hero = () => {
  ...
  return (
    <section 
      id="home"
      className="px-12 w-full flex xl:flex-row flex-col justify-center min-h-screen gap-10 max-container">
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        ...
        <div className="flex justify-start items-start flex-wrap w-full pt-10 mt-5 gap-10">
          {statistics.map((stat)=>(
          <div key={stat.label}>
